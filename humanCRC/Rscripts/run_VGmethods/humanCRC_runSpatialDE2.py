...
humanCRCh5ad = '/projectnb/weber-lr/SVGs-vs-HVGs/humanCRC/outputs/humanCRC38b22230c29b94.h5ad'
...
df_res.to_csv(path_or_buf='/projectnb/weber-lr/SVGs-vs-HVGs/humanCRC/outputs/humanCRC_SpatialDE2_results.csv')
