...
spe <- readRDS("/projectnb/weber-lr/SVGs-vs-HVGs/mouseEmbryo/outputs/mouseEmbryo.rds")

# plot ground truth labels in spatial 
xyplot_groundtruth <- plotSpots(spe, annotate = "ground_truth", 
                                pal = "libd_layer_colors",
                                point_size = 0.7) 
ggsave("xyplot_groundtruth.png", path = "/projectnb/weber-lr/SVGs-vs-HVGs/mouseEmbryo/plots/clustering")
...
write_tsv(df, file = "/projectnb/weber-lr/SVGs-vs-HVGs/mouseEmbryo/plots/clustering/ari_table.tsv")
