...
humanGBMh5ad = '/projectnb/weber-lr/SVGs-vs-HVGs/humanGBM/outputs/humanGBM1474346fdfc0a3.h5ad'
...
df_res.to_csv(path_or_buf='/projectnb/weber-lr/SVGs-vs-HVGs/humanGBM/outputs/humanGBM_SpaDE2_results.csv')
